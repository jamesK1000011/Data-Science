...
function(input, output) {
  ...
  output$my_plot <- renderPlot({                # assign plot to output contents of my_plot element
      plot(CMP$Yield, CMP$BiologicalMaterial01) # define plot to be assigned to output my_table element
  })
